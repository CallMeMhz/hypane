"""Panel icons and colors configuration."""

# Terminal-inspired muted color palette (深邃低调)
TITLE_COLORS = {
    "gray": "#6b7280",
    "red": "#b45b5b",
    "orange": "#b87333",
...
# Lucide icon SVG paths (outline style, 24x24 viewBox)
ICON_SVGS = {
...
def get_icon_svg(icon_name: str) -> str:
    """Get SVG path content for an icon."""
    return ICON_SVGS.get(icon_name, ICON_SVGS[DEFAULT_ICON])


def get_color(color_name: str) -> str:
    """Get color value by name."""
    return TITLE_COLORS.get(color_name, TITLE_COLORS[DEFAULT_COLOR])


def list_colors() -> list[str]:
    """List available color names."""
    return list(TITLE_COLORS.keys())


def list_icons() -> list[str]:
    """List available icon names."""
    return list(ICON_SVGS.keys())
